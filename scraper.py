...
def run_agent():
   ...
   # 4. Bezpieczne filtrowanie Polaków + Biała/Czarna Lista
    ...
    BLACKLIST = ["Oszust1", "FakePolak", "1αmW7ll", "bloodr4yne", "L1Z4RD" , "Krinzhik", "jerk god", "slime pidor", "Polshik", "tv/krinzhikdoto", "kick/krinzhikdoto", "Maheshwara"] # <-- Tutaj wpisujesz trolli
